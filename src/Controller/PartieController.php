...
#[Route('/partie')]
#[IsGranted('ROLE_USER')] // Permet de restreindre le controller uniquement aux utilisateurs authentifier
final class PartieController extends AbstractController
{
    ...
    public function index(PartieRepository $partieRepository): Response
    {
        return $this->render('partie/index.html.twig', [
            'parties' => $partieRepository->findBy(['user' => $this->getUser()]), // $this->getUser() : permet d'obtenir l'utilisateur connecté
        ]);
    }
